...
<br/>
          ...
          <div className="w-full bg-[#e8d7dc] border border-[#dcbabf] rounded-xl px-8 py-10 md:px-10 md:py-14 flex flex-col items-start shadow-sm relative z-10">
            ...
            <button className="px-6 py-6 text-md font-bold text-white bg-[#8a1551] hover:from-purple-700 hover:to-purple-800 rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center mx-auto min-h-[60px] min-w-[200px]">
